...
export async function generateMetadata({ params }: CasesPageMetadataProps): Promise<Metadata> {
  ...
  return generateBaseMetadata({
    ...
    keywords: [
      'портфолио веб-разработчика казахстан',
      'примеры сайтов казахстан',
      'кейсы разработки казахстан',
      'разработка сайтов казахстан примеры',
      'ии автоматизация кейсы',
      'веб-приложения казахстан портфолио',
    ],
  });
}
