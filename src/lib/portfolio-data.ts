...
export const PORTFOLIO_PROJECTS: readonly PortfolioProject[] = [
  {
    id: 'invix-kz',
    title: 'INVIX.KZ — Платформа для организации мероприятий',
    description: 'Мультитенантная SaaS-платформа для организации мероприятий в Казахстане: свадьбы, дни рождения, корпоративы. Монорепозиторий на Next.js 14 + NestJS с tRPC, RBAC, QR-чекин, тикетинг, дизайн-редактор приглашений и тарифная система (FREE/PRO/BUSINESS).',
    shortDescription: 'SaaS-платформа для мероприятий с RBAC, QR-чекином и конструктором приглашений',
    image: '/invix_project.png',
    imageAlt: 'INVIX.KZ — Платформа для организации мероприятий',
    url: 'https://invix.kz',
    tags: ['Next.js', 'NestJS', 'tRPC', 'PostgreSQL', 'Redis', 'Docker', 'Prisma', 'MinIO'],
    ...
    metrics: [
      { label: 'Доменных модулей', value: '12+' },
      { label: 'Ролей RBAC', value: '6' },
      { label: 'Тарифных планов', value: '3' },
      { label: 'End-to-end type safety', value: '100%' },
    ],
    metricKeys: ['domainModules', 'rbacRoles', 'pricingPlans', 'typeSafety'],
  },
  {
    id: 'zakyat-kz',
  ...
  },
  {
    ...
    image: '/egemen-kz-migration-portfolio.jpg',
