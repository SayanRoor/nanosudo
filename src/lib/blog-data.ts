...
export const BLOG_POSTS: readonly BlogPostSource[] = [
  {
    slug: "ai-development-environment-setup-claude-guide",
    image: "/build_fast_website.jpg",
    publishedAt: "2026-06-03",
    author: "Sayan Roor",
    tags: ["AI", "Claude Code", "Developer Tools", "macOS", "Windows", "MCP"],
    readingTime: 17,
    featured: true,
    translations: {
      title: {
        ru: "Среда разработки для работы с ИИ в 2026: полный гайд (Mac + Windows + Claude)",
        en: "AI development environment in 2026: the complete guide (Mac + Windows + Claude)",
        kk: "2026 жылы ЖИ-мен жұмысқа арналған әзірлеу ортасы: толық нұсқаулық (Mac + Windows + Claude)",
      },
      description: {
        ru: "Свежее практическое руководство 2026 года: как с нуля настроить среду разработки на macOS и Windows, подключить ИИ-ассистента Claude Code, настроить MCP и выстроить эффективный рабочий процесс с ИИ.",
        en: "A fresh 2026 hands-on guide: setting up a development environment on macOS and Windows from scratch, installing the Claude Code AI assistant, configuring MCP and building an effective AI-assisted workflow.",
        kk: "2026 жылғы жаңа практикалық нұсқаулық: macOS пен Windows-та әзірлеу ортасын нөлден баптау, Claude Code ЖИ-ассистентін қосу, MCP-ді баптау және ЖИ-мен тиімді жұмыс процесін құру.",
      },
      excerpt: {
        ru: "От пустого ноутбука до полноценной ИИ-среды: терминал, Node.js, Git, VS Code и Claude Code с MCP. Самое свежее практическое руководство 2026 года для Mac и Windows.",
        en: "From a blank laptop to a full AI dev setup: terminal, Node.js, Git, VS Code and Claude Code with MCP. The freshest 2026 hands-on guide for Mac and Windows.",
        kk: "Бос ноутбуктан толыққанды ЖИ-ортасына дейін: терминал, Node.js, Git, VS Code және MCP-мен Claude Code. Mac пен Windows үшін 2026 жылғы ең жаңа практикалық нұсқаулық.",
      },
      imageAlt: {
        ru: "Настройка среды разработки с ИИ-ассистентом Claude",
        en: "Setting up a development environment with the Claude AI assistant",
        kk: "Claude ЖИ-ассистентімен әзірлеу ортасын баптау",
      },
      category: {
        ru: "Разработка",
        en: "Development",
      ...
      content: {
        ru: `# Среда разработки для работы с ИИ в 2026
...
Если нужна помощь с настройкой ИИ-процессов в вашей команде или разработка проекта под ключ — [свяжитесь со мной](/contact), и обсудим задачу.`,
        en: `# AI development environment in 2026
...
If you need help setting up AI workflows for your team or building a project end-to-end — [get in touch](/contact) and let's talk.`,
        kk: `# 2026 жылы ЖИ-мен жұмысқа арналған әзірлеу ортасы
...
Командаңызда ЖИ-процестерін баптауға немесе жобаны кілтін салып беруге көмек керек болса — [менімен байланысыңыз](/contact), тапсырманы талқылайық.`,
      },
    },
  },
  {
